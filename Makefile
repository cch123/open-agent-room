...
help:
	...
	@printf "\nConfig: PORT DATA_PATH SLOCK_TOKEN SLOCK_SERVER_URL OPEN_AGENT_RUNNER OPEN_AGENT_RUNNER_FORMAT OPEN_AGENT_RUNNER_TIMEOUT OPEN_AGENT_RUNNER_WORKDIR\n"
...
dev:
	...
	server_pid=$$!; \
	sleep 1; \
	SLOCK_SERVER_URL="$(SLOCK_SERVER_URL)" SLOCK_TOKEN="$(SLOCK_TOKEN)" OPEN_AGENT_RUNNER="$(OPEN_AGENT_RUNNER)" OPEN_AGENT_RUNNER_FORMAT="$(OPEN_AGENT_RUNNER_FORMAT)" OPEN_AGENT_RUNNER_TIMEOUT="$(OPEN_AGENT_RUNNER_TIMEOUT)" OPEN_AGENT_RUNNER_WORKDIR="$(OPEN_AGENT_RUNNER_WORKDIR)" go run ./cmd/daemon & \
	daemon_pid=$$!; \
